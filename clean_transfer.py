...
# 1️⃣ Load raw transfer data
df = pd.read_csv('team_transfers.csv')

# 2️⃣ Standardize monetary columns (remove weird characters and convert to float)
...
# 3️⃣ Standardize team names using mapping to your canonical list
team_mapping = {
    'Arsenal FC': 'Arsenal',
